...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item {{ Route::currentRouteName() == 'admin.informations' ? 'active' : '' }}" href="{{ route('admin.informations') }}">
                <i class="app-menu__icon fa fa-cogs"></i>
                <span class="app-menu__label">Product Informations</span>
            </a>
        </li>
        <li>
